...
class History : AppCompatActivity() {
        ...
        if (userid != null) {
            CoroutineScope(Dispatchers.Main).launch {
                try {
                    ...
                    val documents = imagesCollectionRef.get().await()
                    handleFetchSuccess(documents)
                } catch (e: Exception) {
    ...
    private fun handleFetchSuccess(documents: QuerySnapshot) {
    ...
    private fun handleFetchFailure(exception: Exception) {
